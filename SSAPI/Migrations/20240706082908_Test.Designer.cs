            ...
            modelBuilder.Entity("SharedLibrary.Model.EmployeeManagement.MstUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("3085f2ea-4afa-4caa-a9e9-5137867838d5"),
                            CreatedBy = "Auto",
                            CreatedDate = new DateTime(2024, 7, 6, 13, 29, 8, 45, DateTimeKind.Local).AddTicks(9545),
                            Email = "",
                            Password = "super@123",
                            UpdatedBy = "Auto",
                            UpdatedDate = new DateTime(2024, 7, 6, 13, 29, 8, 45, DateTimeKind.Local).AddTicks(9556),
                            UserCode = "manager",
                            UserType = 1,
                            cAppStamp = "Auto",
                            flgActive = true,
