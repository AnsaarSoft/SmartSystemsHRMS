...
namespace SSAPI.Migrations
{
    ...
    [Migration("20240706150317_bankbranch_field_updated")]
    partial class bankbranch_field_updated
    {
            ...
            modelBuilder.Entity("SharedLibrary.Model.EmployeeManagement.MstUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("455073d4-18ac-49f4-9287-bc40d497626b"),
                            CreatedBy = "Auto",
                            CreatedDate = new DateTime(2024, 7, 6, 20, 3, 16, 550, DateTimeKind.Local).AddTicks(915),
                            Email = "",
                            Password = "super@123",
                            UpdatedBy = "Auto",
                            UpdatedDate = new DateTime(2024, 7, 6, 20, 3, 16, 550, DateTimeKind.Local).AddTicks(933),
                            UserCode = "manager",
                            UserType = 1,
                            cAppStamp = "Auto",
                            flgActive = true,
